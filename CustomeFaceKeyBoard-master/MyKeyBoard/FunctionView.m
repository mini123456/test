...
{
    NSLog(@"FunctionView_initWithFrame=====================");
...
{
    NSLog(@"FunctionView_setFunctionBlock=====================");
    self.block = block;
}
